...
Where a defender touchs the ball in a way that disrupts the movement of the ball but without the defenders teamn gaining control, the defender shall be credited with a Deflection event, idenfied as 'DEF' followed the team (A or B) and jersey number of that player.
...
In certain exceptional situations, it is possible for the 'official' score at a given point in the game to be set to a specific value, different to that which would be determined by calculating all the succesful Shot Attempts in the game record up until that point. This includes the following situations:
